...
public class Cuboid extends SpaceShape implements IVolumeMeasurable{
	...
	public double getArea() {
		...
		return 2*this.getWidth()*this.getDepth() + 2*this.getDepth()*this.getHeight() + 2*this.getWidth()*this.getHeight();
	}
	...
	public String toString() {
		...
		result += String.format("Volume: " + Math.round(getVolume()) + " Area: " + Math.round(getArea()) + "\n");
		return result;
	}
}
